    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center px-8 py-16">
        <div className="max-w-2xl w-full text-center">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-blue-50 text-blue-600 rounded-full text-sm font-semibold mb-8 border border-blue-100">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center items-center">
            <button
              ...
              disabled={loading}
              className="flex items-center gap-3 px-7 py-3.5 bg-gray-900 text-white rounded-xl font-semibold hover:bg-gray-800 transition-all shadow-lg hover:-translate-y-0.5 disabled:opacity-70 text-base"
            >
              ...
              {loading ? '...' : t('home.ctaSignIn')}
            </button>
          </div>

          <p className="mt-4 text-sm text-gray-400">{t('home.signInPrompt')}</p>
        </div>
      </div>

      {/* Features */}
      <div className="border-t border-gray-100 px-8 py-12 bg-gray-50/50">
