...
export const translations = {
  ky: {
    ...
    form: {
      ...
      providerGeminiDesc: 'Google Gemini моделдери менен генерациялоо',
      providerOpenAiDesc: 'OpenAI ChatGPT моделдери менен генерациялоо',
      slideCount: 'Слайддардын саны',
      apiKey: '{provider} API Key (Милдеттүү эмес)',
      ...
      removeFile: 'Өчүрүү',
      rateLimitError: 'AI лимити толду. Өз API ключуңузду колдонуп, ишти улантыңыз.',
      rateLimitHint: '{provider} үчүн өз API ключуңузду алып, "Кошумча жөндөөлөр" бөлүмүнө киргизиңиз.',
      getApiKey: '{provider} API ключ алуу',
      apiKeyHint: 'Өз ключуңуз болсо — чектеоо жок.',
      saveApiKey: 'Ключту сактоо',
      apiKeySaved: 'Ключ сакталды',
      apiKeyAlreadySaved: 'Аккаунтуңузда сакталган ключ бар',
      apiKeySaveError: 'Ключ сакталган жок',
      apiKeyLocalHint: 'Бул ключ аккаунтуңузга сакталат жана кийинки генерацияларда автоматтык колдонулат.',
      usedApiKey: 'Колдонулган ключ: {key}',
  ...
  ru: {
    ...
    form: {
      ...
      providerGeminiDesc: 'Генерация через модели Google Gemini',
      providerOpenAiDesc: 'Генерация через модели OpenAI ChatGPT',
      slideCount: 'Количество слайдов',
      apiKey: '{provider} API Key (Необязательно)',
      ...
      removeFile: 'Удалить',
      rateLimitError: 'Лимит AI исчерпан. Используйте свой API-ключ, чтобы продолжить работу.',
      rateLimitHint: 'Получите свой API-ключ для {provider} и вставьте его в «Дополнительные настройки».',
      getApiKey: 'Получить API-ключ {provider}',
      apiKeyHint: 'Со своим ключом — без ограничений.',
      saveApiKey: 'Сохранить ключ',
      apiKeySaved: 'Ключ сохранен',
      apiKeyAlreadySaved: 'Для аккаунта уже сохранен ключ',
      apiKeySaveError: 'Ключ не сохранен',
      apiKeyLocalHint: 'Этот ключ сохраняется в вашем аккаунте и автоматически используется при следующих генерациях.',
      usedApiKey: 'Использованный ключ: {key}',
  ...
  en: {
    ...
    form: {
      ...
      providerGeminiDesc: 'Generate with Google Gemini models',
      providerOpenAiDesc: 'Generate with OpenAI ChatGPT models',
      ...
      removeFile: 'Remove',
      rateLimitError: 'AI quota exceeded. Use your own API key to keep working.',
      rateLimitHint: 'Get your {provider} API key and paste it into "Advanced Settings".',
      getApiKey: 'Get {provider} API Key',
      apiKeyHint: 'With your own key — no limits.',
      saveApiKey: 'Save key',
      apiKeySaved: 'Key saved',
      apiKeyAlreadySaved: 'A key is already saved for this account',
      apiKeySaveError: 'Key was not saved',
      apiKeyLocalHint: 'This key is saved to your account and used automatically for future generations.',
      usedApiKey: 'Used key: {key}',
